...
export default function AboutUs() {
  return (
    <section id="about-us" className="bg-gradient-to-br from-purple-50 to-gray-100 py-20 px-6 md:px-12">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.p
          ...
          className="mt-8 font-light text-md sm:text-xl leading-relaxed text-gray-800 font-montserrat"
        >
